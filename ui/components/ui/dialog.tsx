...
// Bunlar wrapper değil, direkt alias ✅ (forwardRef zinciri bozulmuyor)
const Dialog = DialogPrimitive.Root
const DialogTrigger = DialogPrimitive.Trigger
const DialogPortal = DialogPrimitive.Portal
const DialogClose = DialogPrimitive.Close

// Overlay artık forwardRef ✅
...
// Content + showCloseButton, forwardRef ile ✅
    ...
    >
      ...
      {showCloseButton && (
        <DialogPrimitive.Close
          ...
          className="absolute right-4 top-4 rounded-xs opacity-70 transition-opacity 
